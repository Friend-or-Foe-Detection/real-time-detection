...
def main(args):
    print(f"--- Starting Reproduction of yolov8s3 ---")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Reproduce YOLO training run yolov8s3.")
