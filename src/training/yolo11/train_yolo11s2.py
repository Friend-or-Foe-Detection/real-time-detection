...
def main(args):
    print(f"--- Starting Reproduction of yolo11s2 ---")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Reproduce YOLO training run yolo11s2.")
